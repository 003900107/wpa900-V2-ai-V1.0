...
int16_t PeriodCycleTab[10][SAMP_POINT_NBR];
...
void Sampling_IRQHandler(void)
{
  ...
  PeriodCycleTab[UA][PeriodCycle_Index]=OverSampling(ADC21_ConvertedValueTab,16);
  PeriodCycleTab[UB][PeriodCycle_Index]=OverSampling(ADC22_ConvertedValueTab,16);
  PeriodCycleTab[UC][PeriodCycle_Index]=OverSampling(ADC23_ConvertedValueTab,16);
  PeriodCycleTab[U0][PeriodCycle_Index]=OverSampling(ADC24_ConvertedValueTab,16);
  PeriodCycleTab[IA][PeriodCycle_Index]=OverSampling(ADC11_ConvertedValueTab,16);
  PeriodCycleTab[IB][PeriodCycle_Index]=OverSampling(ADC12_ConvertedValueTab,16);
  PeriodCycleTab[IC][PeriodCycle_Index]=OverSampling(ADC13_ConvertedValueTab,16);
  
  //tyh:20150803 增加DO出口延时
  if (32 == PeriodCycle_Index) 
  {
    DO_Process();
  }
}
...
{	
  temp_FreqCounter[FreqTabIndex&0x1f]=TIM5->CCR4;
